...
public class LowerUpperClassMan {
    public static void main(String[]args){
        ...
        low=Paths.get("Lowerclassmen.txt");
        up=Paths.get("Upperclassmen.txt");

        try{
            OutputStream lowStr=new BufferedOutputStream(Files.newOutputStream(low, CREATE, WRITE));
            BufferedWriter writeLower=new BufferedWriter(new OutputStreamWriter(lowStr));

            OutputStream upStr=new BufferedOutputStream(Files.newOutputStream(up, CREATE, WRITE));
            ...
            do{
                ...
                }while(!y);//takes student ID number
                ...
                }while(!y);//allows the user to enter another record or quit
...
//		System.out.println("Record length: "+recordLength);//46
        ...
        try{
            InputStream lowIn=new BufferedInputStream(Files.newInputStream(low,
                    READ));
            BufferedReader readLower=new BufferedReader(new InputStreamReader(lowIn));

            InputStream uppIn=new BufferedInputStream(Files.newInputStream(up,
                    READ));
